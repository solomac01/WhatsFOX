...
<div align="center">
  ...
  ![WhatsFOX Logo](https://i.hizliresim.com/4qwhek1.jpg)
...
<p align="center">
    WhatsFOX project - Makes it easy and fun to use Whatsapp. Also first userbot for Whatsapp.
    <br>
</p>
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/CEHunter30/WhatsFOX)

### The Hard Method (Not Recommend)
```js
$ git clone https://github.com/CEHunter30/WhatsFOX.git
$ cd WhatsFOX
$ npm i
$ nano config.env
...
### 💵 Is it paid?
**Of course not.** It will never happen. But you can donate to us. You can reach me via) .
...
## Contributing
Contributing to the WhatsFOX project, world first UserBot for WhatsApp. 
